...
export function useEquipmentFindMany<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useEquipmentFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.equipment.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useEquipmentCount<T extends Prisma.equipmentCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.equipmentCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useEquipmentCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.equipment.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useEquipmentFindManyWithCount<
  T extends Prisma.equipmentFindManyArgs,
  R extends { data: GetFindResult<Prisma.$equipmentPayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.equipmentFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useEquipmentFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.equipment.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useEquipmentFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useEquipmentFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.equipment.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
